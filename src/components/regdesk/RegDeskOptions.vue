    ...
    <TabPanels class="min-h-[35rem] min-w-[56rem]">
      <TabPanel value="0">
        <div class="flex flex-col gap-2">
          ...
          />
          <LabeledToggleSwitch
            label="Reset filter when checking in"
            v-model="displayOptionsRef.checkinAutoResetFilter"
          />
          <LabeledToggleSwitch
            label="Show filter help text"
            v-model="displayOptionsRef.displayFilterHelp"
          />
          <LabeledToggleSwitch
            label="Show filter summary"
            v-model="displayOptionsRef.displayFilterSummary"
          />
      ...
      <TabPanel value="1">
        <div class="flex flex-col gap-2 w-full">
          ...
          />
          <LabeledRelativeSlider
            :label="`Font Size: ${displayOptionsRef.displayRunner.size}`"
            :withParens="true"
